...
It rewards attention without changing the core loop in [2: The Mechanics](../../game-overview/2-the-mechanics/).
...
* Scale cleanly with [Excavation](../../game-overview/5-rpg-skilling-system/) level.
