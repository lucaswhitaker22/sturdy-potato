-- 20240116000010_seismic_rpc.sql
-- Creates rpc_extract_seismic to definitively solve caching issues.

CREATE OR REPLACE FUNCTION public.rpc_extract_seismic(p_user_id UUID DEFAULT NULL, p_seismic_grade TEXT DEFAULT NULL)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
GRANT EXECUTE ON FUNCTION public.rpc_extract_seismic(UUID, TEXT) TO service_role, authenticated, anon;
