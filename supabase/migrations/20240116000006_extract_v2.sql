-- 20240116000006_extract_v2.sql
-- Creates rpc_extract_v2 to bypass schema caching issues.

CREATE OR REPLACE FUNCTION public.rpc_extract_v2(p_user_id UUID DEFAULT NULL, p_seismic_grade TEXT DEFAULT NULL)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
GRANT EXECUTE ON FUNCTION public.rpc_extract_v2(UUID, TEXT) TO service_role, authenticated, anon;
